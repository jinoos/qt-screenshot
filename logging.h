...
#define _LOG_SERROR   "ERROR"
#define _LOG_SFATAL   "FATAL"
#define _LOG_SMSG     "MSG  "

#define _LOG_SSDEBUG   "DEBUG"
#define _LOG_SSINFO    "INFO"
#define _LOG_SSWARN    "WARN"
#define _LOG_SSERROR   "ERROR"
#define _LOG_SSFATAL   "FATAL"
...
#define log_err(F, ...)		{log_str(_LOG_ERR, __FILE__, __LINE__, _LOG_SERROR, F, ##__VA_ARGS__);}
#define log_fatal(F, ...)   {log_str(_LOG_FATAL, __FILE__, __LINE__, _LOG_SFATAL, F, ##__VA_ARGS__);exit(-1);}
...
#define log_nerr(F, ...)	{log_nstr(_LOG_ERR, __FILE__, __LINE__, _LOG_SERROR, F, ##__VA_ARGS__);}
#define log_nfatal(F, ...)	{log_nstr(_LOG_FATAL, __FILE__, __LINE__, _LOG_SFATAL, F, ##__VA_ARGS__); exit(-1);}
...
static inline int log_fatal_enable()
{
    return log_level_compare(log_level(0), _LOG_FATAL);
}
